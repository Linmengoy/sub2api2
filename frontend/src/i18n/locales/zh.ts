    ...
    settings: {
      ...
      features: {
        ...
        packageRedeemSaleRebate: {
          title: '分销返利配置',
          description: '配置套餐兑换码核销后的销售返利规则，与邀请返利独立计算。',
          enabled: '启用分销返利',
          enabledHint: '启用后，他人核销用户购买的套餐兑换码时，可按配置给购买者发放销售返利。',
          defaultRatePercent: '默认分成比例',
          defaultRatePercentHint: '按套餐兑换码购买订单的实际支付金额计算，0 表示不发放。',
          freezeHours: '返利冻结期（小时）',
          freezeHoursDesc: '新产生的分销返利将在冻结期内无法提现。0 = 不冻结。',
          perRedeemerCap: '同一兑换者返利上限',
          perRedeemerCapDesc: '同一兑换者为同一购买者贡献的累计返利上限。0 = 无上限。',
          perOrderCap: '单订单返利上限',
          perOrderCapDesc: '单个套餐兑换码购买订单可产生的返利上限。0 = 无上限。',
        },
      },
