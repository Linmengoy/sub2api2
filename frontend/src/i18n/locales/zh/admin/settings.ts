    ...
    settings: {
      ...
      features: {
        ...
        packageRedeemSaleRebate: {
          title: '套餐兑换码销售返利',
          description: '购买者分享套餐兑换码，他人兑换后购买者按比例获得余额返利。默认关闭。',
          enabled: '启用套餐兑换码销售返利',
          enabledHint: '关闭后，用户侧菜单隐藏，新兑换不再产生返利；已有返利余额保留。',
          defaultRatePercent: '默认返利比例（%）',
          defaultRatePercentHint: '分享的兑换码被兑换时，默认返还给购买者的比例（0-100，例如 10 = 10%）。',
          freezeHours: '返利冻结期（小时）',
          freezeHoursDesc: '新产生的返利将在冻结期内不可用。0 = 不冻结。',
          perRedeemerCap: '单兑换者返利上限',
          perRedeemerCapDesc: '同一兑换者累计产生的返利上限。0 = 无上限。',
          perOrderCap: '单次兑换返利上限',
          perOrderCapDesc: '单次兑换产生的返利上限。0 = 无上限。',
        },
      },
