    ...
    settings: {
      ...
      features: {
        ...
        packageRedeemSaleRebate: {
          title: 'Package Redeem Sale Rebate',
          description: 'Purchasers share package redeem codes; when a shared code is redeemed, the purchaser earns a percentage rebate to their balance. Disabled by default.',
          enabled: 'Enable Package Redeem Sale Rebate',
          enabledHint: 'When off, the user menu is hidden and new redemptions generate no rebate. Existing rebate balances are kept.',
          defaultRatePercent: 'Default Rebate Rate (%)',
          defaultRatePercentHint: 'Default percentage credited to the purchaser when a shared code is redeemed (0-100, e.g. 10 = 10%).',
          freezeHours: 'Rebate Freeze Period (hours)',
          freezeHoursDesc: 'New rebates will be frozen for this period before becoming available. 0 = no freeze.',
          perRedeemerCap: 'Per-Redeemer Rebate Cap',
          perRedeemerCapDesc: 'Maximum total rebate generated by a single redeemer. 0 = no limit.',
          perOrderCap: 'Per-Order Rebate Cap',
          perOrderCapDesc: 'Maximum rebate for a single redemption. 0 = no limit.',
        },
      },
