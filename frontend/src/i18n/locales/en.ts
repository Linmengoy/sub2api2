export default {
  ...
  nav: {
    ...
    packageRedeemAffiliate: 'Distribution Rebate',
    affiliateManagement: 'Affiliate Rebates',
    affiliateInviteRecords: 'Invite Records',
    affiliateRebateRecords: 'Rebate Records',
    affiliateTransferRecords: 'Transfer Records',
    packageRedeemAffiliateManage: 'Distribution Rebate',
    profile: 'Profile',
    users: 'Users',
    groups: 'Groups',
    channels: 'Channels',
  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        packageRedeemSaleRebate: {
          title: 'Distribution Rebate Settings',
          description: 'Configure sales rebate rules after package redeem codes are redeemed, calculated independently from invite rebates.',
          enabled: 'Enable Distribution Rebate',
          enabledHint: 'When enabled, buyers can receive sales rebates when others redeem package codes they purchased.',
          defaultRatePercent: 'Default Commission Rate',
          defaultRatePercentHint: 'Calculated from the actual paid amount of the package redeem code order. 0 means no rebate.',
          freezeHours: 'Rebate Freeze Period (hours)',
          freezeHoursDesc: 'New distribution rebates remain unavailable during this period. 0 = no freeze.',
          perRedeemerCap: 'Per-Redeemer Rebate Cap',
          perRedeemerCapDesc: 'Maximum cumulative rebate contributed by the same redeemer to the same buyer. 0 = no limit.',
          perOrderCap: 'Per-Order Rebate Cap',
          perOrderCapDesc: 'Maximum rebate generated by a single package redeem code purchase order. 0 = no limit.',
        },
      },
