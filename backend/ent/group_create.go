...
func (_c *GroupCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if group.DefaultCreatedAt == nil {
			return fmt.Errorf("ent_tmp: uninitialized group.DefaultCreatedAt (forgotten import ent_tmp/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if group.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent_tmp: uninitialized group.DefaultUpdatedAt (forgotten import ent_tmp/runtime?)")
		}
...
func (_c *GroupCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent_tmp: missing required field "Group.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent_tmp: missing required field "Group.updated_at"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent_tmp: missing required field "Group.name"`)}
	}
	if v, ok := _c.mutation.Name(); ok {
		if err := group.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.RateMultiplier(); !ok {
		return &ValidationError{Name: "rate_multiplier", err: errors.New(`ent_tmp: missing required field "Group.rate_multiplier"`)}
	}
	if _, ok := _c.mutation.PeakRateEnabled(); !ok {
		return &ValidationError{Name: "peak_rate_enabled", err: errors.New(`ent_tmp: missing required field "Group.peak_rate_enabled"`)}
	}
	if _, ok := _c.mutation.PeakStart(); !ok {
		return &ValidationError{Name: "peak_start", err: errors.New(`ent_tmp: missing required field "Group.peak_start"`)}
	}
	if v, ok := _c.mutation.PeakStart(); ok {
		if err := group.PeakStartValidator(v); err != nil {
			return &ValidationError{Name: "peak_start", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.peak_start": %w`, err)}
		}
	}
	if _, ok := _c.mutation.PeakEnd(); !ok {
		return &ValidationError{Name: "peak_end", err: errors.New(`ent_tmp: missing required field "Group.peak_end"`)}
	}
	if v, ok := _c.mutation.PeakEnd(); ok {
		if err := group.PeakEndValidator(v); err != nil {
			return &ValidationError{Name: "peak_end", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.peak_end": %w`, err)}
		}
	}
	if _, ok := _c.mutation.PeakRateMultiplier(); !ok {
		return &ValidationError{Name: "peak_rate_multiplier", err: errors.New(`ent_tmp: missing required field "Group.peak_rate_multiplier"`)}
	}
	if _, ok := _c.mutation.IsExclusive(); !ok {
		return &ValidationError{Name: "is_exclusive", err: errors.New(`ent_tmp: missing required field "Group.is_exclusive"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent_tmp: missing required field "Group.status"`)}
	}
	if v, ok := _c.mutation.Status(); ok {
		if err := group.StatusValidator(v); err != nil {
			return &ValidationError{Name: "status", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.status": %w`, err)}
		}
	}
	if v, ok := _c.mutation.DuplicateOperationID(); ok {
		if err := group.DuplicateOperationIDValidator(v); err != nil {
			return &ValidationError{Name: "duplicate_operation_id", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.duplicate_operation_id": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Platform(); !ok {
		return &ValidationError{Name: "platform", err: errors.New(`ent_tmp: missing required field "Group.platform"`)}
	}
	if v, ok := _c.mutation.Platform(); ok {
		if err := group.PlatformValidator(v); err != nil {
			return &ValidationError{Name: "platform", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.platform": %w`, err)}
		}
	}
	if _, ok := _c.mutation.SubscriptionType(); !ok {
		return &ValidationError{Name: "subscription_type", err: errors.New(`ent_tmp: missing required field "Group.subscription_type"`)}
	}
	if v, ok := _c.mutation.SubscriptionType(); ok {
		if err := group.SubscriptionTypeValidator(v); err != nil {
			return &ValidationError{Name: "subscription_type", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.subscription_type": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DefaultValidityDays(); !ok {
		return &ValidationError{Name: "default_validity_days", err: errors.New(`ent_tmp: missing required field "Group.default_validity_days"`)}
	}
	if _, ok := _c.mutation.AllowImageGeneration(); !ok {
		return &ValidationError{Name: "allow_image_generation", err: errors.New(`ent_tmp: missing required field "Group.allow_image_generation"`)}
	}
	if _, ok := _c.mutation.AllowBatchImageGeneration(); !ok {
		return &ValidationError{Name: "allow_batch_image_generation", err: errors.New(`ent_tmp: missing required field "Group.allow_batch_image_generation"`)}
	}
	if _, ok := _c.mutation.ImageRateIndependent(); !ok {
		return &ValidationError{Name: "image_rate_independent", err: errors.New(`ent_tmp: missing required field "Group.image_rate_independent"`)}
	}
	if _, ok := _c.mutation.ImageRateMultiplier(); !ok {
		return &ValidationError{Name: "image_rate_multiplier", err: errors.New(`ent_tmp: missing required field "Group.image_rate_multiplier"`)}
	}
	if _, ok := _c.mutation.BatchImageDiscountMultiplier(); !ok {
		return &ValidationError{Name: "batch_image_discount_multiplier", err: errors.New(`ent_tmp: missing required field "Group.batch_image_discount_multiplier"`)}
	}
	if _, ok := _c.mutation.BatchImageHoldMultiplier(); !ok {
		return &ValidationError{Name: "batch_image_hold_multiplier", err: errors.New(`ent_tmp: missing required field "Group.batch_image_hold_multiplier"`)}
	}
	if _, ok := _c.mutation.VideoRateIndependent(); !ok {
		return &ValidationError{Name: "video_rate_independent", err: errors.New(`ent_tmp: missing required field "Group.video_rate_independent"`)}
	}
	if _, ok := _c.mutation.VideoRateMultiplier(); !ok {
		return &ValidationError{Name: "video_rate_multiplier", err: errors.New(`ent_tmp: missing required field "Group.video_rate_multiplier"`)}
	}
	if v, ok := _c.mutation.SearchPricePer1k(); ok {
		if err := group.SearchPricePer1kValidator(v); err != nil {
			return &ValidationError{Name: "search_price_per_1k", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.search_price_per_1k": %w`, err)}
		}
	}
	if v, ok := _c.mutation.AudioRealtimePricePerMin(); ok {
		if err := group.AudioRealtimePricePerMinValidator(v); err != nil {
			return &ValidationError{Name: "audio_realtime_price_per_min", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.audio_realtime_price_per_min": %w`, err)}
		}
	}
	if v, ok := _c.mutation.AudioTtsPricePerMillionChars(); ok {
		if err := group.AudioTtsPricePerMillionCharsValidator(v); err != nil {
			return &ValidationError{Name: "audio_tts_price_per_million_chars", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.audio_tts_price_per_million_chars": %w`, err)}
		}
	}
	if v, ok := _c.mutation.AudioSttPricePerHour(); ok {
		if err := group.AudioSttPricePerHourValidator(v); err != nil {
			return &ValidationError{Name: "audio_stt_price_per_hour", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.audio_stt_price_per_hour": %w`, err)}
		}
	}
	if _, ok := _c.mutation.LongContextPricingEnabled(); !ok {
		return &ValidationError{Name: "long_context_pricing_enabled", err: errors.New(`ent_tmp: missing required field "Group.long_context_pricing_enabled"`)}
	}
	if _, ok := _c.mutation.ClaudeCodeOnly(); !ok {
		return &ValidationError{Name: "claude_code_only", err: errors.New(`ent_tmp: missing required field "Group.claude_code_only"`)}
	}
	if _, ok := _c.mutation.ModelRoutingEnabled(); !ok {
		return &ValidationError{Name: "model_routing_enabled", err: errors.New(`ent_tmp: missing required field "Group.model_routing_enabled"`)}
	}
	if _, ok := _c.mutation.McpXMLInject(); !ok {
		return &ValidationError{Name: "mcp_xml_inject", err: errors.New(`ent_tmp: missing required field "Group.mcp_xml_inject"`)}
	}
	if _, ok := _c.mutation.SupportedModelScopes(); !ok {
		return &ValidationError{Name: "supported_model_scopes", err: errors.New(`ent_tmp: missing required field "Group.supported_model_scopes"`)}
	}
	if _, ok := _c.mutation.SortOrder(); !ok {
		return &ValidationError{Name: "sort_order", err: errors.New(`ent_tmp: missing required field "Group.sort_order"`)}
	}
	if _, ok := _c.mutation.AllowMessagesDispatch(); !ok {
		return &ValidationError{Name: "allow_messages_dispatch", err: errors.New(`ent_tmp: missing required field "Group.allow_messages_dispatch"`)}
	}
	if _, ok := _c.mutation.AllowLive(); !ok {
		return &ValidationError{Name: "allow_live", err: errors.New(`ent_tmp: missing required field "Group.allow_live"`)}
	}
	if _, ok := _c.mutation.ForceOpenaiFast(); !ok {
		return &ValidationError{Name: "force_openai_fast", err: errors.New(`ent_tmp: missing required field "Group.force_openai_fast"`)}
	}
	if _, ok := _c.mutation.FreeOpenaiFast(); !ok {
		return &ValidationError{Name: "free_openai_fast", err: errors.New(`ent_tmp: missing required field "Group.free_openai_fast"`)}
	}
	if _, ok := _c.mutation.RequireOauthOnly(); !ok {
		return &ValidationError{Name: "require_oauth_only", err: errors.New(`ent_tmp: missing required field "Group.require_oauth_only"`)}
	}
	if _, ok := _c.mutation.RequirePrivacySet(); !ok {
		return &ValidationError{Name: "require_privacy_set", err: errors.New(`ent_tmp: missing required field "Group.require_privacy_set"`)}
	}
	if _, ok := _c.mutation.DefaultMappedModel(); !ok {
		return &ValidationError{Name: "default_mapped_model", err: errors.New(`ent_tmp: missing required field "Group.default_mapped_model"`)}
	}
	if v, ok := _c.mutation.DefaultMappedModel(); ok {
		if err := group.DefaultMappedModelValidator(v); err != nil {
			return &ValidationError{Name: "default_mapped_model", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.default_mapped_model": %w`, err)}
		}
	}
	if _, ok := _c.mutation.MessagesDispatchModelConfig(); !ok {
		return &ValidationError{Name: "messages_dispatch_model_config", err: errors.New(`ent_tmp: missing required field "Group.messages_dispatch_model_config"`)}
	}
	if _, ok := _c.mutation.ModelAllowlist(); !ok {
		return &ValidationError{Name: "model_allowlist", err: errors.New(`ent_tmp: missing required field "Group.model_allowlist"`)}
	}
	if _, ok := _c.mutation.CodexModelsManifestConfig(); !ok {
		return &ValidationError{Name: "codex_models_manifest_config", err: errors.New(`ent_tmp: missing required field "Group.codex_models_manifest_config"`)}
	}
	if _, ok := _c.mutation.RpmLimit(); !ok {
		return &ValidationError{Name: "rpm_limit", err: errors.New(`ent_tmp: missing required field "Group.rpm_limit"`)}
	}
	if _, ok := _c.mutation.MaxReasoningEffort(); !ok {
		return &ValidationError{Name: "max_reasoning_effort", err: errors.New(`ent_tmp: missing required field "Group.max_reasoning_effort"`)}
	}
	if v, ok := _c.mutation.MaxReasoningEffort(); ok {
		if err := group.MaxReasoningEffortValidator(v); err != nil {
			return &ValidationError{Name: "max_reasoning_effort", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.max_reasoning_effort": %w`, err)}
		}
	}
	if _, ok := _c.mutation.MaxReasoningEffortOverLimit(); !ok {
		return &ValidationError{Name: "max_reasoning_effort_over_limit", err: errors.New(`ent_tmp: missing required field "Group.max_reasoning_effort_over_limit"`)}
	}
	if v, ok := _c.mutation.MaxReasoningEffortOverLimit(); ok {
		if err := group.MaxReasoningEffortOverLimitValidator(v); err != nil {
			return &ValidationError{Name: "max_reasoning_effort_over_limit", err: fmt.Errorf(`ent_tmp: validator failed for field "Group.max_reasoning_effort_over_limit": %w`, err)}
		}
	}
	if _, ok := _c.mutation.ReasoningEffortMappings(); !ok {
		return &ValidationError{Name: "reasoning_effort_mappings", err: errors.New(`ent_tmp: missing required field "Group.reasoning_effort_mappings"`)}
	}
	if _, ok := _c.mutation.ProfitControlEnabled(); !ok {
		return &ValidationError{Name: "profit_control_enabled", err: errors.New(`ent_tmp: missing required field "Group.profit_control_enabled"`)}
	}
	if _, ok := _c.mutation.ProfitMinMargin(); !ok {
		return &ValidationError{Name: "profit_min_margin", err: errors.New(`ent_tmp: missing required field "Group.profit_min_margin"`)}
	}
	if _, ok := _c.mutation.ProfitSafetyBuffer(); !ok {
		return &ValidationError{Name: "profit_safety_buffer", err: errors.New(`ent_tmp: missing required field "Group.profit_safety_buffer"`)}
	}
	return nil
}
...
func (u *GroupUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for GroupCreate.OnConflict")
	}
...
func (u *GroupUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_tmp: OnConflict was set for builder %d. Set it on the GroupCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for GroupCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
