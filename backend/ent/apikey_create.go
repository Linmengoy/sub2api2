...
func (_c *APIKeyCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if apikey.DefaultCreatedAt == nil {
			return fmt.Errorf("ent_tmp: uninitialized apikey.DefaultCreatedAt (forgotten import ent_tmp/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if apikey.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent_tmp: uninitialized apikey.DefaultUpdatedAt (forgotten import ent_tmp/runtime?)")
		}
...
func (_c *APIKeyCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent_tmp: missing required field "APIKey.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent_tmp: missing required field "APIKey.updated_at"`)}
	}
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent_tmp: missing required field "APIKey.user_id"`)}
	}
	if _, ok := _c.mutation.Key(); !ok {
		return &ValidationError{Name: "key", err: errors.New(`ent_tmp: missing required field "APIKey.key"`)}
	}
	if v, ok := _c.mutation.Key(); ok {
		if err := apikey.KeyValidator(v); err != nil {
			return &ValidationError{Name: "key", err: fmt.Errorf(`ent_tmp: validator failed for field "APIKey.key": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent_tmp: missing required field "APIKey.name"`)}
	}
	if v, ok := _c.mutation.Name(); ok {
		if err := apikey.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`ent_tmp: validator failed for field "APIKey.name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent_tmp: missing required field "APIKey.status"`)}
	}
	if v, ok := _c.mutation.Status(); ok {
		if err := apikey.StatusValidator(v); err != nil {
			return &ValidationError{Name: "status", err: fmt.Errorf(`ent_tmp: validator failed for field "APIKey.status": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Quota(); !ok {
		return &ValidationError{Name: "quota", err: errors.New(`ent_tmp: missing required field "APIKey.quota"`)}
	}
	if _, ok := _c.mutation.QuotaUsed(); !ok {
		return &ValidationError{Name: "quota_used", err: errors.New(`ent_tmp: missing required field "APIKey.quota_used"`)}
	}
	if _, ok := _c.mutation.RateLimit5h(); !ok {
		return &ValidationError{Name: "rate_limit_5h", err: errors.New(`ent_tmp: missing required field "APIKey.rate_limit_5h"`)}
	}
	if _, ok := _c.mutation.RateLimit1d(); !ok {
		return &ValidationError{Name: "rate_limit_1d", err: errors.New(`ent_tmp: missing required field "APIKey.rate_limit_1d"`)}
	}
	if _, ok := _c.mutation.RateLimit7d(); !ok {
		return &ValidationError{Name: "rate_limit_7d", err: errors.New(`ent_tmp: missing required field "APIKey.rate_limit_7d"`)}
	}
	if _, ok := _c.mutation.Usage5h(); !ok {
		return &ValidationError{Name: "usage_5h", err: errors.New(`ent_tmp: missing required field "APIKey.usage_5h"`)}
	}
	if _, ok := _c.mutation.Usage1d(); !ok {
		return &ValidationError{Name: "usage_1d", err: errors.New(`ent_tmp: missing required field "APIKey.usage_1d"`)}
	}
	if _, ok := _c.mutation.Usage7d(); !ok {
		return &ValidationError{Name: "usage_7d", err: errors.New(`ent_tmp: missing required field "APIKey.usage_7d"`)}
	}
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`ent_tmp: missing required edge "APIKey.user"`)}
	}
	return nil
}
...
func (u *APIKeyUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for APIKeyCreate.OnConflict")
	}
...
func (u *APIKeyUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_tmp: OnConflict was set for builder %d. Set it on the APIKeyCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for APIKeyCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
