...
func (_c *UserPlatformQuotaCreate) defaults() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if userplatformquota.DefaultCreatedAt == nil {
			return fmt.Errorf("ent_tmp: uninitialized userplatformquota.DefaultCreatedAt (forgotten import ent_tmp/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if userplatformquota.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent_tmp: uninitialized userplatformquota.DefaultUpdatedAt (forgotten import ent_tmp/runtime?)")
		}
...
func (_c *UserPlatformQuotaCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent_tmp: missing required field "UserPlatformQuota.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent_tmp: missing required field "UserPlatformQuota.updated_at"`)}
	}
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent_tmp: missing required field "UserPlatformQuota.user_id"`)}
	}
	if _, ok := _c.mutation.Platform(); !ok {
		return &ValidationError{Name: "platform", err: errors.New(`ent_tmp: missing required field "UserPlatformQuota.platform"`)}
	}
	if v, ok := _c.mutation.Platform(); ok {
		if err := userplatformquota.PlatformValidator(v); err != nil {
			return &ValidationError{Name: "platform", err: fmt.Errorf(`ent_tmp: validator failed for field "UserPlatformQuota.platform": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DailyUsageUsd(); !ok {
		return &ValidationError{Name: "daily_usage_usd", err: errors.New(`ent_tmp: missing required field "UserPlatformQuota.daily_usage_usd"`)}
	}
	if _, ok := _c.mutation.WeeklyUsageUsd(); !ok {
		return &ValidationError{Name: "weekly_usage_usd", err: errors.New(`ent_tmp: missing required field "UserPlatformQuota.weekly_usage_usd"`)}
	}
	if _, ok := _c.mutation.MonthlyUsageUsd(); !ok {
		return &ValidationError{Name: "monthly_usage_usd", err: errors.New(`ent_tmp: missing required field "UserPlatformQuota.monthly_usage_usd"`)}
	}
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`ent_tmp: missing required edge "UserPlatformQuota.user"`)}
	}
	return nil
}
...
func (u *UserPlatformQuotaUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for UserPlatformQuotaCreate.OnConflict")
	}
...
func (u *UserPlatformQuotaUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_tmp: OnConflict was set for builder %d. Set it on the UserPlatformQuotaCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for UserPlatformQuotaCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
