...
func (_u *AccountUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		if account.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("ent_tmp: uninitialized account.UpdateDefaultUpdatedAt (forgotten import ent_tmp/runtime?)")
		}
...
func (_u *AccountUpdateOne) sqlSave(ctx context.Context) (_node *Account, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent_tmp: missing "Account.id" for update`)}
	}
