...
func (_c *ChannelMonitorDailyRollupCreate) check() error {
	if _, ok := _c.mutation.MonitorID(); !ok {
		return &ValidationError{Name: "monitor_id", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.monitor_id"`)}
	}
	if _, ok := _c.mutation.Model(); !ok {
		return &ValidationError{Name: "model", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.model"`)}
	}
	if v, ok := _c.mutation.Model(); ok {
		if err := channelmonitordailyrollup.ModelValidator(v); err != nil {
			return &ValidationError{Name: "model", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitorDailyRollup.model": %w`, err)}
		}
	}
	if _, ok := _c.mutation.BucketDate(); !ok {
		return &ValidationError{Name: "bucket_date", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.bucket_date"`)}
	}
	if _, ok := _c.mutation.TotalChecks(); !ok {
		return &ValidationError{Name: "total_checks", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.total_checks"`)}
	}
	if _, ok := _c.mutation.OkCount(); !ok {
		return &ValidationError{Name: "ok_count", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.ok_count"`)}
	}
	if _, ok := _c.mutation.OperationalCount(); !ok {
		return &ValidationError{Name: "operational_count", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.operational_count"`)}
	}
	if _, ok := _c.mutation.DegradedCount(); !ok {
		return &ValidationError{Name: "degraded_count", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.degraded_count"`)}
	}
	if _, ok := _c.mutation.FailedCount(); !ok {
		return &ValidationError{Name: "failed_count", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.failed_count"`)}
	}
	if _, ok := _c.mutation.ErrorCount(); !ok {
		return &ValidationError{Name: "error_count", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.error_count"`)}
	}
	if _, ok := _c.mutation.SumLatencyMs(); !ok {
		return &ValidationError{Name: "sum_latency_ms", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.sum_latency_ms"`)}
	}
	if _, ok := _c.mutation.CountLatency(); !ok {
		return &ValidationError{Name: "count_latency", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.count_latency"`)}
	}
	if _, ok := _c.mutation.SumPingLatencyMs(); !ok {
		return &ValidationError{Name: "sum_ping_latency_ms", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.sum_ping_latency_ms"`)}
	}
	if _, ok := _c.mutation.CountPingLatency(); !ok {
		return &ValidationError{Name: "count_ping_latency", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.count_ping_latency"`)}
	}
	if _, ok := _c.mutation.ComputedAt(); !ok {
		return &ValidationError{Name: "computed_at", err: errors.New(`ent_tmp: missing required field "ChannelMonitorDailyRollup.computed_at"`)}
	}
	if len(_c.mutation.MonitorIDs()) == 0 {
		return &ValidationError{Name: "monitor", err: errors.New(`ent_tmp: missing required edge "ChannelMonitorDailyRollup.monitor"`)}
	}
	return nil
}
...
func (u *ChannelMonitorDailyRollupUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for ChannelMonitorDailyRollupCreate.OnConflict")
	}
...
func (u *ChannelMonitorDailyRollupUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_tmp: OnConflict was set for builder %d. Set it on the ChannelMonitorDailyRollupCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for ChannelMonitorDailyRollupCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
