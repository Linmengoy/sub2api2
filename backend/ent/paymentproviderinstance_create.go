...
func (_c *PaymentProviderInstanceCreate) check() error {
	if _, ok := _c.mutation.ProviderKey(); !ok {
		return &ValidationError{Name: "provider_key", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.provider_key"`)}
	}
	if v, ok := _c.mutation.ProviderKey(); ok {
		if err := paymentproviderinstance.ProviderKeyValidator(v); err != nil {
			return &ValidationError{Name: "provider_key", err: fmt.Errorf(`ent_tmp: validator failed for field "PaymentProviderInstance.provider_key": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.name"`)}
	}
	if v, ok := _c.mutation.Name(); ok {
		if err := paymentproviderinstance.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`ent_tmp: validator failed for field "PaymentProviderInstance.name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Config(); !ok {
		return &ValidationError{Name: "config", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.config"`)}
	}
	if _, ok := _c.mutation.SupportedTypes(); !ok {
		return &ValidationError{Name: "supported_types", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.supported_types"`)}
	}
	if v, ok := _c.mutation.SupportedTypes(); ok {
		if err := paymentproviderinstance.SupportedTypesValidator(v); err != nil {
			return &ValidationError{Name: "supported_types", err: fmt.Errorf(`ent_tmp: validator failed for field "PaymentProviderInstance.supported_types": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Enabled(); !ok {
		return &ValidationError{Name: "enabled", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.enabled"`)}
	}
	if _, ok := _c.mutation.PaymentMode(); !ok {
		return &ValidationError{Name: "payment_mode", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.payment_mode"`)}
	}
	if v, ok := _c.mutation.PaymentMode(); ok {
		if err := paymentproviderinstance.PaymentModeValidator(v); err != nil {
			return &ValidationError{Name: "payment_mode", err: fmt.Errorf(`ent_tmp: validator failed for field "PaymentProviderInstance.payment_mode": %w`, err)}
		}
	}
	if _, ok := _c.mutation.SortOrder(); !ok {
		return &ValidationError{Name: "sort_order", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.sort_order"`)}
	}
	if _, ok := _c.mutation.Limits(); !ok {
		return &ValidationError{Name: "limits", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.limits"`)}
	}
	if _, ok := _c.mutation.RefundEnabled(); !ok {
		return &ValidationError{Name: "refund_enabled", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.refund_enabled"`)}
	}
	if _, ok := _c.mutation.AllowUserRefund(); !ok {
		return &ValidationError{Name: "allow_user_refund", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.allow_user_refund"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent_tmp: missing required field "PaymentProviderInstance.updated_at"`)}
	}
	return nil
}
...
func (u *PaymentProviderInstanceUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for PaymentProviderInstanceCreate.OnConflict")
	}
...
func (u *PaymentProviderInstanceUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_tmp: OnConflict was set for builder %d. Set it on the PaymentProviderInstanceCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for PaymentProviderInstanceCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
