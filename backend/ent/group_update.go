...
func (_u *GroupUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		if group.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("ent_tmp: uninitialized group.UpdateDefaultUpdatedAt (forgotten import ent_tmp/runtime?)")
		}
...
func (_u *GroupUpdateOne) sqlSave(ctx context.Context) (_node *Group, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent_tmp: missing "Group.id" for update`)}
	}
