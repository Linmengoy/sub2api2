...
func (_c *ChannelMonitorCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.updated_at"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.name"`)}
	}
	if v, ok := _c.mutation.Name(); ok {
		if err := channelmonitor.NameValidator(v); err != nil {
			return &ValidationError{Name: "name", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Provider(); !ok {
		return &ValidationError{Name: "provider", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.provider"`)}
	}
	if v, ok := _c.mutation.Provider(); ok {
		if err := channelmonitor.ProviderValidator(v); err != nil {
			return &ValidationError{Name: "provider", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.provider": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CheckMode(); !ok {
		return &ValidationError{Name: "check_mode", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.check_mode"`)}
	}
	if v, ok := _c.mutation.CheckMode(); ok {
		if err := channelmonitor.CheckModeValidator(v); err != nil {
			return &ValidationError{Name: "check_mode", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.check_mode": %w`, err)}
		}
	}
	if _, ok := _c.mutation.APIMode(); !ok {
		return &ValidationError{Name: "api_mode", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.api_mode"`)}
	}
	if v, ok := _c.mutation.APIMode(); ok {
		if err := channelmonitor.APIModeValidator(v); err != nil {
			return &ValidationError{Name: "api_mode", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.api_mode": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Endpoint(); !ok {
		return &ValidationError{Name: "endpoint", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.endpoint"`)}
	}
	if v, ok := _c.mutation.Endpoint(); ok {
		if err := channelmonitor.EndpointValidator(v); err != nil {
			return &ValidationError{Name: "endpoint", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.endpoint": %w`, err)}
		}
	}
	if _, ok := _c.mutation.APIKeyEncrypted(); !ok {
		return &ValidationError{Name: "api_key_encrypted", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.api_key_encrypted"`)}
	}
	if v, ok := _c.mutation.APIKeyEncrypted(); ok {
		if err := channelmonitor.APIKeyEncryptedValidator(v); err != nil {
			return &ValidationError{Name: "api_key_encrypted", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.api_key_encrypted": %w`, err)}
		}
	}
	if _, ok := _c.mutation.PrimaryModel(); !ok {
		return &ValidationError{Name: "primary_model", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.primary_model"`)}
	}
	if v, ok := _c.mutation.PrimaryModel(); ok {
		if err := channelmonitor.PrimaryModelValidator(v); err != nil {
			return &ValidationError{Name: "primary_model", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.primary_model": %w`, err)}
		}
	}
	if _, ok := _c.mutation.ExtraModels(); !ok {
		return &ValidationError{Name: "extra_models", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.extra_models"`)}
	}
	if v, ok := _c.mutation.GroupName(); ok {
		if err := channelmonitor.GroupNameValidator(v); err != nil {
			return &ValidationError{Name: "group_name", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.group_name": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Enabled(); !ok {
		return &ValidationError{Name: "enabled", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.enabled"`)}
	}
	if _, ok := _c.mutation.IntervalSeconds(); !ok {
		return &ValidationError{Name: "interval_seconds", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.interval_seconds"`)}
	}
	if v, ok := _c.mutation.IntervalSeconds(); ok {
		if err := channelmonitor.IntervalSecondsValidator(v); err != nil {
			return &ValidationError{Name: "interval_seconds", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.interval_seconds": %w`, err)}
		}
	}
	if _, ok := _c.mutation.JitterSeconds(); !ok {
		return &ValidationError{Name: "jitter_seconds", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.jitter_seconds"`)}
	}
	if v, ok := _c.mutation.JitterSeconds(); ok {
		if err := channelmonitor.JitterSecondsValidator(v); err != nil {
			return &ValidationError{Name: "jitter_seconds", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.jitter_seconds": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedBy(); !ok {
		return &ValidationError{Name: "created_by", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.created_by"`)}
	}
	if _, ok := _c.mutation.ExtraHeaders(); !ok {
		return &ValidationError{Name: "extra_headers", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.extra_headers"`)}
	}
	if _, ok := _c.mutation.BodyOverrideMode(); !ok {
		return &ValidationError{Name: "body_override_mode", err: errors.New(`ent_tmp: missing required field "ChannelMonitor.body_override_mode"`)}
	}
	if v, ok := _c.mutation.BodyOverrideMode(); ok {
		if err := channelmonitor.BodyOverrideModeValidator(v); err != nil {
			return &ValidationError{Name: "body_override_mode", err: fmt.Errorf(`ent_tmp: validator failed for field "ChannelMonitor.body_override_mode": %w`, err)}
		}
	}
	return nil
}
...
func (u *ChannelMonitorUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for ChannelMonitorCreate.OnConflict")
	}
...
func (u *ChannelMonitorUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_tmp: OnConflict was set for builder %d. Set it on the ChannelMonitorCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for ChannelMonitorCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
