...
func (_c *PromoCodeUsageCreate) check() error {
	if _, ok := _c.mutation.PromoCodeID(); !ok {
		return &ValidationError{Name: "promo_code_id", err: errors.New(`ent_tmp: missing required field "PromoCodeUsage.promo_code_id"`)}
	}
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent_tmp: missing required field "PromoCodeUsage.user_id"`)}
	}
	if _, ok := _c.mutation.BonusAmount(); !ok {
		return &ValidationError{Name: "bonus_amount", err: errors.New(`ent_tmp: missing required field "PromoCodeUsage.bonus_amount"`)}
	}
	if _, ok := _c.mutation.UsedAt(); !ok {
		return &ValidationError{Name: "used_at", err: errors.New(`ent_tmp: missing required field "PromoCodeUsage.used_at"`)}
	}
	if len(_c.mutation.PromoCodeIDs()) == 0 {
		return &ValidationError{Name: "promo_code", err: errors.New(`ent_tmp: missing required edge "PromoCodeUsage.promo_code"`)}
	}
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`ent_tmp: missing required edge "PromoCodeUsage.user"`)}
	}
	return nil
}
...
func (u *PromoCodeUsageUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for PromoCodeUsageCreate.OnConflict")
	}
...
func (u *PromoCodeUsageUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_tmp: OnConflict was set for builder %d. Set it on the PromoCodeUsageCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_tmp: missing options for PromoCodeUsageCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
