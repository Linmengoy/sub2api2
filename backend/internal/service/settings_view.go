...
type SystemSettings struct {
	...
	PackageRedeemSaleRebateEnabled            bool
	PackageRedeemSaleRebateDefaultRatePercent float64
	PackageRedeemSaleRebateFreezeHours        int
	PackageRedeemSaleRebatePerRedeemerCap     float64
	PackageRedeemSaleRebatePerOrderCap        float64
