...
const (
	PackageRedeemSaleRebateEnabledDefault            = false
	PackageRedeemSaleRebateDefaultRatePercentDefault = 30.0
	PackageRedeemSaleRebateDefaultRatePercentMin     = 0.0
	PackageRedeemSaleRebateDefaultRatePercentMax     = 100.0
	PackageRedeemSaleRebateFreezeHoursDefault        = 0
	PackageRedeemSaleRebateFreezeHoursMax            = 720
	PackageRedeemSaleRebatePerRedeemerCapDefault     = 0.0
	PackageRedeemSaleRebatePerOrderCapDefault        = 0.0
)
...
const (
	...
	SettingKeyPackageRedeemSaleRebateEnabled            = "package_redeem_sale_rebate_enabled"              // 套餐兑换码销售返利功能总开关
	SettingKeyPackageRedeemSaleRebateDefaultRatePercent = "package_redeem_sale_rebate_default_rate_percent" // 套餐兑换码销售返利默认比例（百分比，0-100）
	SettingKeyPackageRedeemSaleRebateFreezeHours        = "package_redeem_sale_rebate_freeze_hours"         // 套餐兑换码销售返利冻结期（小时，0=不冻结）
	SettingKeyPackageRedeemSaleRebatePerRedeemerCap     = "package_redeem_sale_rebate_per_redeemer_cap"     // 同一兑换者返利上限（0=无上限）
	SettingKeyPackageRedeemSaleRebatePerOrderCap        = "package_redeem_sale_rebate_per_order_cap"        // 单订单返利上限（0=无上限）
