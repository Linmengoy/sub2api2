...
func (r *redeemRejectRepo) ListPurchasedByUser(ctx context.Context, userID int64, params pagination.PaginationParams, status string) ([]RedeemCode, *pagination.PaginationResult, error) {
