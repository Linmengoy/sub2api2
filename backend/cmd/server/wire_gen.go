...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	packageRedeemSaleRebateRepository := repository.NewPackageRedeemSaleRebateRepository(client)
	packageRedeemSaleLedgerRepository := repository.NewPackageRedeemSaleLedgerRepository(client)
	packageRedeemSaleRebateService := service.NewPackageRedeemSaleRebateService(packageRedeemSaleRebateRepository, packageRedeemSaleLedgerRepository, settingService, affiliateService, client, apiKeyAuthCacheInvalidator, billingCacheService)
	redeemService := service.NewRedeemService(redeemCodeRepository, userRepository, subscriptionService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator, affiliateService, packageRedeemSaleRebateService)
	...
	adminPackageRedeemAffiliateHandler := admin.NewPackageRedeemAffiliateHandler(adminService, packageRedeemSaleRebateRepository)
	...
	packageRedeemAffiliateHandler := handler.NewPackageRedeemAffiliateHandler(redeemService, packageRedeemSaleRebateRepository, settingService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, packageRedeemAffiliateHandler, availableChannelHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
